                        ...
                        {alertTransition(
                            (styles, item) =>
                                item && (
                                    ...
                                    className='remove-alert-container w-[80%] max-w-[360px] max-h-[100px] xl:max-w-[380px] xl:max-h-[110px] h-1/6 bg-gray-700 border-2 border-gray-500 rounded-lg flex flex-col justify-center items-center'>
                                        <p className="remove-alert-text text-lg text-gray-100 mb-2">Delete this task?</p>
